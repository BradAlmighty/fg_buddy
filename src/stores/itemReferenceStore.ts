...
export const useItemReferenceStore = defineStore("itemReference", {
    ...
    items: {
      generalArmsAndArmorItems: [
        ...
        },
        {
          ...
          maximumRange: 24,
          notes:
            "Load and fire as seperate actions, may reload in place of movement; must have a quiver.",
        },
        {
          id: "FGCBI0007",
          name: "Unarmed",
  ...
  getters: {
    ...
    getGeneralArmsAndArmorItems: (state) =>
      state.items.generalArmsAndArmorItems,
